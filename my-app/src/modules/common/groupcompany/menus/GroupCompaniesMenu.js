...
export default function GroupCompaniesMenu() {
  ...
  const menuItems = [
    { path: "/get-group-companies", text: "View Group Companies", canRender: canViewModule }, // Add the "canRender" property
    { path: "/create-group-company", text: "Create Group Company", canRender: canCreateModule },
