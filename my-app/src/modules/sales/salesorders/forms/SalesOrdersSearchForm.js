...
function SalesOrdersSearchForm() {
  ...
  const handleSearch = (e) => {
    ...
    const searchPath = searchQueryString
      ? `/sales-order-results?${searchQueryString}`
      : "/sales-order-results";
  ...
  return (
    <div className="child-container menu-container">
      <h2 className="title">Sales order Search</h2>
      <div className="child-container form-container">
        {hasRequiredAccess ? (
            ...
            <div className="form-group col-md-6 mb-2">
              <div className="form-row">
                ...
                <input
                  ...
                  id="param_so_num"
                  name="param_so_num"
                  value={queryParams.param_so_num}
                  onChange={handleInputChange}
                  className="form-control input-field"
                />
              </div>
          ...
          <div>
            ...
            {logger.warn(
              `[${new Date().toLocaleTimeString()}] Permission denied: User does not have access to view the Sales Orders module. (hasRequiredAccess: ${hasRequiredAccess})`
            )}
          </div>
        )}
      </div>
...
export default SalesOrdersSearchForm;
