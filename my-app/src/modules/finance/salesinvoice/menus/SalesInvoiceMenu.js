...
export default function SalesInvoiceMenu() {
  ...
  const menuItems = [
    { path: "/create-sales-invoice", text: "New Invoice", canRender: canCreateModule },
  ...
  logger.info(`[${new Date().toLocaleTimeString()}] Sales component is rendering.`);
